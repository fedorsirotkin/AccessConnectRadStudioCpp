...
void __fastcall TFormMain::FormCreate(TObject *Sender)
{
	...
	// Расписание сеансов - SessionSchedule
	...
	// Страны производства - CountriesProduction
...
{
	Application->MessageBox(L"НГТУ, ИРИТ\nстудент группы 16-ИСТв-1 \nСироткин Фёдор", L"Об авторе", MB_OK);
}
//---------------------------------------------------------------------------

void __fastcall TFormMain::NAboutProgramClick(TObject *Sender)
{
	Application->MessageBox(L"Программа \"Сеть кинотеатров\", версия 1.0.0\nРеализует связь Microsoft Access с C++\\CLI Embarcadero RAD Studio \nОбеспечивает графический интерфейс к БД при помощи VCL Forms", L"О программе", MB_OK);
}
//---------------------------------------------------------------------------
