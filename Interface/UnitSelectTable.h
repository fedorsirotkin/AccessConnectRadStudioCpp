...
__published:	// IDE-managed Components
	...
	TIntegerField *ADOTableFilmGenresÆàíğ;
	TIntegerField *ADOTableFilmGenresÔèëüì;
	TAutoIncField *ADOTableGenresÈÄ;
	TWideStringField *ADOTableGenresÍàèìåíîâàíèå;
	TStringField *ADOTableFilmGenresÆàíğLookup;
	TStringField *ADOTableFilmGenresÔèëüìLookup;
	TAutoIncField *ADOTableHallsÈÄ;
	TWideStringField *ADOTableHallsÍàèìåíîâàíèå;
	TWideStringField *ADOTableHallsÑîñòîÿíèå;
	TIntegerField *ADOTableHallsÂìåñòèìîñòü;
	TIntegerField *ADOTableHallsÊèíîòåàòğ;
	TStringField *ADOTableHallsÊèíîòåàòğLookup;
	TAutoIncField *ADOTableFilmCompaniesÈÄ;
	TWideStringField *ADOTableFilmCompaniesÍàèìåíîâàíèå;
	TAutoIncField *ADOTableCinemasÈÄ;
	TWideStringField *ADOTableCinemasÍàèìåíîâàíèå;
	TWideStringField *ADOTableCinemasÀäğåñ;
	TWideStringField *ADOTableCinemasÒåëåôîí;
	TWideStringField *ADOTableCinemasÑàéò;
	TIntegerField *ADOTableCinemasÂìåñòèìîñòü;
	TAutoIncField *ADOTablePlacesÈÄ;
	TSmallintField *ADOTablePlacesÍîìåğ;
	TIntegerField *ADOTablePlacesĞÿä;
	TIntegerField *ADOTablePlacesÒèïìåñòà;
	TIntegerField *ADOTablePlacesÖåíà;
	TStringField *ADOTablePlacesĞÿäLookup;
	TStringField *ADOTablePlacesÒèïìåñòàLookup;
	TAutoIncField *ADOTableTicketSellingÈÄ;
	TIntegerField *ADOTableTicketSellingÑåàíñ;
	TIntegerField *ADOTableTicketSellingÌåñòî;
	TStringField *ADOTableTicketSellingÑåàíñLookup;
	TAutoIncField *ADOTableMovieRentalÈÄ;
	TDateTimeField *ADOTableMovieRentalÂûõîäâïğîêàò;
	TDateTimeField *ADOTableMovieRentalÑíÿòèåñïğîêàòà;
	TIntegerField *ADOTableMovieRentalÔèëüì;
	TStringField *ADOTableMovieRentalÔèëüìLookup;
	TAutoIncField *ADOTableSessionScheduleÈÄ;
	TIntegerField *ADOTableSessionScheduleÔèëüì;
	TDateTimeField *ADOTableSessionScheduleÄàòà;
	TIntegerField *ADOTableSessionScheduleÇàë;
	TStringField *ADOTableSessionScheduleÇàëLookup;
	TStringField *ADOTableSessionScheduleÔèëüìLookup2;
	TAutoIncField *ADOTableDirectorsÈÄ;
	TWideStringField *ADOTableDirectorsÍàèìåíîâàíèå;
	TAutoIncField *ADOTableRowsÈÄ;
	TIntegerField *ADOTableRowsÍîìåğ;
	TIntegerField *ADOTableRowsÇàë;
	TStringField *ADOTableRowsÇàëLookup;
	TAutoIncField *ADOTableCountriesProductionÈÄ;
	TWideStringField *ADOTableCountriesProductionÍàèìåíîâàíèå;
	TAutoIncField *ADOTableTypesPlacesÈÄ;
	TWideStringField *ADOTableTypesPlacesÍàèìåíîâàíèå;
	TAutoIncField *ADOTableFilmsÈÄ;
	TWideStringField *ADOTableFilmsÍàçâàíèå;
	TIntegerField *ADOTableFilmsÃîäâûïóñêà;
	TIntegerField *ADOTableFilmsÄëèòåëüíîñòü;
	TWideStringField *ADOTableFilmsÎïèñàíèå;
	TIntegerField *ADOTableFilmsÂîçğàñò;
	TIntegerField *ADOTableFilmsÊèíîêîìïàíèÿ;
	TIntegerField *ADOTableFilmsĞåæèññåğ;
	TIntegerField *ADOTableFilmsÑòğàíàïğîèçâîäèòåëü;
	TStringField *ADOTableFilmsÊèíîêîìïàíèÿLookup;
	TStringField *ADOTableFilmsĞåæèññåğLookup2;
	TStringField *ADOTableFilmsÑòğàíàïğîèçâîäèòåëüLookup;
	...
	void __fastcall RadioButtonFilmsAscClick(TObject *Sender);
	void __fastcall RadioButtonFilmsDescClick(TObject *Sender);
